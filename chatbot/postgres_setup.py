...
from chatbot.models import Channel, Config, Guild, Profile, db
...
for profile in data['profile']:
    Profile(**profile).save(force_insert=True)
...
# Profile, Guild, and Channels can all be checked together as they're all
